...
/**
 * Privacy Subsystem implementation for block_course_info.
 *
...
namespace block_course_info\privacy;
...
class provider implements
        // The block_course_info block stores user provided data.
        \core_privacy\local\metadata\provider,

        // This plugin is capable of determining which users have data within it.
        core_userlist_provider,

        // The block_course_info block provides data directly to core.
        \core_privacy\local\request\plugin\provider {

    /**
     * Returns information about how block_course_info stores its data.
     *
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        foreach ($instances as $instance) {
            ...
            $html = writer::with_context($context)
                ->rewrite_pluginfile_urls([], 'block_course_info', 'content', null, $block->config->text);

            // Default to FORMAT_HTML which is what will have been used before the
            // editor was properly implemented for the block.
            $format = $block->config->format ?? FORMAT_HTML;
