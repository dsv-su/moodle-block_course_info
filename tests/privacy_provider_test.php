...
/**
 * Unit tests for the block_course_info implementation of the privacy API.
 *
...
use \block_course_info\privacy\provider;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_course_info_privacy_testcase extends \core_privacy\tests\provider_testcase {
    /**
     ...
     *
     * @param \page $page Page
     * @return \block_course_info Block instance object
     */
    ...
    public function test_user_block() {
        ...
        // Export the data.
        $this->export_context_data_for_user($user->id, $context, 'block_course_info');
    ...
    public function test_user_multiple_blocks_exported() {
        ...
        $approvedlist = new approved_contextlist($user, 'block_course_info', $contextlist->get_contextids());
    ...
    public function test_get_users_in_context() {
        ...
        \block_course_info\privacy\provider::get_users_in_context($userlist);
    ...
    public function test_delete_data_for_users() {
        ...
        \block_course_info\privacy\provider::get_users_in_context($userlist1);
        $userlist2 = new \core_privacy\local\request\userlist($context2, $component);
        \block_course_info\privacy\provider::get_users_in_context($userlist2);
        ...
        $approvedlist = new approved_userlist($context1, 'block_course_info', $userlist1->get_userids());
